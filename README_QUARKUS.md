...
0) <span style="color: red;">Forward the ports of your KYMA cluster to local ports ( kafa 30001, redis 30099, postgres 30002 ), see your application.properties file</span>.


``` kubectl
kubectl port-forward 30001 localport:30001
```
...
2) Test the REST using the [http curls](http/curls.http)
...
You can then execute your native executable with: `./target/quarkus_kafka-1.0-SNAPSHOT-runner`
